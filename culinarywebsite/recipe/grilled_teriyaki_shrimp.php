...
<html>
    ...
    <body>
        <div class="flex-container">
            ...
            <div class="content">
                <h1 class="recipe_title">Grilled Teriyaki Shrimp</h1>
                ...
                <img class="recipe_img" src="grilled_teriyaki_shrimp.png">

                <p class="recipe_desc">These savory-sweet shrimp skewers are easy to make and cook in just a few minutes. They are perfect for summer weeknights or weekend dinner parties. Prep the sauce ahead of time for an even faster dinner. I prefer to use jumbo shrimp (21 to 25 per pound), however use what you have on hand.
                </p>
